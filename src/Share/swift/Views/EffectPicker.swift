...
struct EffectPicker: View {
  ...
  private let effects: [EffectEntry] = [
    ...
    EffectEntry(name: "Line (gray)", value: .lineGray, color: Color.gray),
    EffectEntry(name: "Line (light)", value: .lineLight, color: Color.white),
    EffectEntry(name: "Line (dark)", value: .lineDark, color: Color.black),
